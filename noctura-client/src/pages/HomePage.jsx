...
export default function HomePage() {
  ...
  return <><HeroBanner movie={data.trending[0]} /><div className="home-content"><MovieRow title="Trending now" subtitle="The titles everyone is talking about" movies={data.trending} /><MovieRow title="Popular on Noctura" movies={data.popular} /><MovieRow title="Top rated" movies={data.top} /><MovieRow title="Now playing" movies={data.now} /><MovieRow title="Action & adventure" movies={data.action} /><MovieRow title="Coming soon" movies={data.upcoming} /></div></>;
}
